...
(function dartProgram() {
  ...
  L = {ServerValue: function ServerValue() {
    ...
    TagView_convert: function(definedTag) {
      var t2, t3,
        t1 = definedTag.text,
        element = document.createElement("div");
      C.DivElement_methods.set$text(element, t1);
      element.className = "tag";
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      t1 = t2._eval$1("~(1)?")._as(new L.TagView_convert_closure(new E.Tag(t1), element, definedTag));
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(element, "click", t1, false, t2._precomputed1);
      t2 = definedTag.children;
      t1 = H._arrayInstanceType(t2);
      t3 = t1._eval$1("MappedListIterable<1,HtmlElement>");
      W._ChildrenElementList__addAll(element, type$.Iterable_Element._as(P.List_List$of(new H.MappedListIterable(t2, t1._eval$1("HtmlElement(1)")._as(new L.TagView_convert_closure0()), t3), true, t3._eval$1("ListIterable.E"))));
      return element;
    },
  ...
  K = {JsObjectWrapper: function JsObjectWrapper() {
    ...
    ArticleCategoryView_convert: function(articleCategory) {
      var t1, t2, t3,
        element = document.createElement("div");
      C.DivElement_methods.set$text(element, articleCategory.text);
      element.className = "category";
      t1 = type$._ElementEventStreamImpl_MouseEvent;
      t2 = t1._eval$1("~(1)?")._as(new K.ArticleCategoryView_convert_closure(element, articleCategory));
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(element, "click", t2, false, t1._precomputed1);
      t1 = articleCategory.children;
      t2 = H._arrayInstanceType(t1);
      t3 = t2._eval$1("MappedListIterable<1,HtmlElement>");
      W._ChildrenElementList__addAll(element, type$.Iterable_Element._as(P.List_List$of(new H.MappedListIterable(t1, t2._eval$1("HtmlElement(1)")._as(new K.ArticleCategoryView_convert_closure0()), t3), true, t3._eval$1("ListIterable.E"))));
      return element;
    },
  ...
  K.ArticleCategoryView_convert_closure0.prototype = {
    call$1: function(e) {
      return K.ArticleCategoryView_convert(type$.DefinedArticleCategory._as(e));
    },
    $signature: 7
  };
  ...
  F._insertTagList_closure.prototype = {
    call$1: function(e) {
      return L.TagView_convert(type$.DefinedWebTag._as(e));
    },
    $signature: 6
  };
  ...
  (function installTearOffs() {
    ...
    _instance(P._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 23, 0);
  })();
  ...
  var init = {
    ...
    metadata: [],
    types: ["~()", "~(String,@)", "~(~())", "~(@)", "Null(~)", "Null()", "HtmlElement(DefinedWebTag)", "HtmlElement(DefinedArticleCategory)", "~(MouseEvent)", "~(Event)", "Null(@)", "~(Uint8List,String,int)", "@()", "_Future<@>(@)", "Future<Null>()", "~(Object,StackTrace)", "~(@,@)", "~(Object?,Object?)", "Null(Object,StackTrace)", "~(String,int)", "~(String[@])", "int(int,int)", "Uint8List(@,@)", "~(Object[StackTrace?])", "~(ProgressEvent)", "@(String)", "~(int,@)", "Null(@,StackTrace)", "@(@,@)", "bool(Node)", "Element(Node)", "ArticleCategory(String)", "Tag(String)", "@(@,String)", "~(Element)", "@(@)", "Null(@,@)", "bool(Article)", "Null(~())", "HtmlElement(Article)", "~(String,String)"],
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "DefinedWebTag_parentCategories", "$get$DefinedWebTag_parentCategories", function() {
      ...
      return H.setRuntimeTypeInfo([new E.DefinedWebTag("Entity", H.setRuntimeTypeInfo([new E.DefinedWebTag("Zombie", H.setRuntimeTypeInfo([], t1))], t1)), new E.DefinedWebTag("Player", H.setRuntimeTypeInfo([], t1)), new E.DefinedWebTag("World", H.setRuntimeTypeInfo([], t1)), new E.DefinedWebTag("Particle", H.setRuntimeTypeInfo([], t1)), new E.DefinedWebTag("Effect", H.setRuntimeTypeInfo([], t1)), new E.DefinedWebTag("Plugin", H.setRuntimeTypeInfo([new E.DefinedWebTag("PVE", H.setRuntimeTypeInfo([], t1)), new E.DefinedWebTag("PVP", H.setRuntimeTypeInfo([], t1))], t1))], t1);
    });
  })();
